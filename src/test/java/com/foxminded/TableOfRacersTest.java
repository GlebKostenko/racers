...
class TableOfRacersTest {
    ...
    private TableOfRacers test = new TableOfRacers(start,end,abbreviations);

    @Test
    void makeRacersTable() throws IOException {
        ...
        assertEquals(expected,test.makeRacersTable());
    }
}